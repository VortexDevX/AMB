...
class BuildSequenceGenerator:
    ...
    def generate_sequence(
        ...
        for phase_id in range(Phase.num_phases()):
            ...
            blocks = self._order_blocks(blocks, randomize_xz=self.randomize_within_phase)
            ...
            for x, y, z, role in blocks:
                ...
                action = BuildAction(x=x, y=y, z=z, block_type=block_type, phase=phase_id)
