...
DECOR_BLOCKS: Set[str] = {
    ...
    'lantern', 'soul_lantern', 'candle', 'sea_pickle',
    'flower', 'poppy', 'dandelion', 'rose', 'tulip', 'orchid', 'allium',
    'azure_bluet', 'oxeye_daisy', 'cornflower', 'lily_of_the_valley',
    'wither_rose', 'sunflower', 'lilac', 'peony', 'rose_bush',
    'banner', 'sign', 'wall_sign', 'hanging_sign',
    ...
    'flower_pot', 'potted_', 'decorated_pot',
    'head', 'skull', 'player_head', 'zombie_head', 'skeleton_skull',
    'creeper_head', 'dragon_head', 'piglin_head',
    'armor_stand',
    'fence', 'fence_gate', 'nether_brick_fence',
    'wall', 'cobblestone_wall', 'mossy_cobblestone_wall', 'brick_wall',
    'prismarine_wall', 'sandstone_wall', 'red_sandstone_wall',
}
...
class BlockSimplifier:
    ...
    def simplify_blocks(self, blocks: np.ndarray, use_classic_ids: bool = True) -> np.ndarray:
        """
