...
STRUCTURE_KEYWORDS = {
    "house": ["house", "home", "cottage", "villa", "manor", "residence", "dwelling", "bungalow", "starter", "survival"],
    "castle": ["castle", "fortress", "keep", "citadel", "stronghold", "palace"],
    "tower": ["tower", "turret", "spire", "minaret", "watchtower", "lighthouse", "beacon"],
    "church": ["church", "chapel", "cathedral", "temple", "shrine", "mosque", "abbey"],
    "cabin": ["cabin", "log_cabin", "lodge", "chalet", "cozy"],
    "medieval": ["medieval", "tavern", "inn", "blacksmith", "smithy", "market", "village"],
...
def main():
    parser = argparse.ArgumentParser(description="Auto-organize Minecraft schematic dataset")
    parser.add_argument("--clean", "-c", action="store_true", help="Clean and re-organize everything")
    parser.add_argument("--dir", "-d", type=str, default=None, help="Root datasets directory")
