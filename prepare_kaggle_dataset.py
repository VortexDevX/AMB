...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--source", "-s", default="datasets/organized", help="Source directory"
    )
    parser.add_argument(
        "--output", "-o", default="kaggle_dataset.zip", help="Output ZIP file"
    )
    parser.add_argument(
        "--max-files", "-m", type=int, default=None, help="Max files to include"
    )
